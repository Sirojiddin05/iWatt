...
enum ConnectorStatus {
  free(LocaleKeys.free, AppColors.limeGreen, AppIcons.freeStatusIcon),
  busy(LocaleKeys.busy, AppColors.jungleMist, ''),
  booked(LocaleKeys.busy, AppColors.jungleMist, ''),
  notWorking(LocaleKeys.does_not_work, AppColors.amaranth, AppIcons.notWorkingStatusIcon);

  final String title;
  final Color color;
  final String icon;

  const ConnectorStatus(this.title, this.color, this.icon);
