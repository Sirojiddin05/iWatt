...
class GetUpdatedLocationsUseCase implements UseCase<List<ChargeLocationEntity>, NoParams> {
  final MapRepository repo;
  const GetUpdatedLocationsUseCase(this.repo);

  @override
  Future<Either<Failure, List<ChargeLocationEntity>>> call(NoParams params) async {
    return await repo.getUpdatedLocations();
  }
}
