...
class GetCreatedLocationsUseCase implements UseCase<List<ChargeLocationEntity>, NoParams> {
  final MapRepository repo;
  const GetCreatedLocationsUseCase(this.repo);

  @override
  Future<Either<Failure, List<ChargeLocationEntity>>> call(NoParams params) async {
    return await repo.getCreatedLocations();
  }
}
