...
class SearchHistoryBloc extends Bloc<SearchHistoryEvent, SearchHistoryState> {
  ...
  SearchHistoryBloc({
    ...
    on<GetSearchHistoryEvent>((event, emit) async {
      ...
      if (result.isRight) {
        emit(state.copyWith(getSearchHistoryStatus: FormzSubmissionStatus.success, searchHistory: result.right.results));
      } else {
    ...
    on<DeleteSingleSearchHistoryEvent>((event, emit) async {
      ...
      emit(state.copyWith(deleteSingleSearchHistoryStatus: FormzSubmissionStatus.inProgress, searchHistory: [...searchHistory]));
