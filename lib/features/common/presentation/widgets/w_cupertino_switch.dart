...
class WCupertinoSwitch extends StatefulWidget {
  ...
  const WCupertinoSwitch({
    ...
    this.inactiveColor = AppColors.geyser,
              ...
              AnimatedPositioned(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppColors.whiteLilac.withOpacity(0.04), width: 0.1),
                    boxShadow: [
                      BoxShadow(blurRadius: 1, offset: const Offset(0, 0), color: AppColors.black.withOpacity(0.04)),
                    ],
                  ),
                ),
              )
