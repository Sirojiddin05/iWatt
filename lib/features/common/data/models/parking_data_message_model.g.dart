...
ParkingDataMessageModel _$ParkingDataMessageModelFromJson(
        Map<String, dynamic> json) =>
    ParkingDataMessageModel(
...
Map<String, dynamic> _$ParkingDataMessageModelToJson(
        ParkingDataMessageModel instance) =>
    <String, dynamic>{
