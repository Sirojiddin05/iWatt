...
abstract class NotificationDataSource {
  ...
  Future<void> registerDeviceIdAndKey({required String registrationId, required String? deviceId, required String deviceType});
}
...
class NotificationDataSourceImpl extends NotificationDataSource {
  ...
  @override
  Future<void> registerDeviceIdAndKey({required String registrationId, required String? deviceId, required String deviceType}) async {
    try {
