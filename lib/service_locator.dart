...
Future<void> setupLocator() async {
  ...
  serviceLocator.registerLazySingleton(
      () => TransactionHistoryRepositoryImpl(serviceLocator<TransactionHistoryDatasourceImpl>()));
  serviceLocator.registerLazySingleton(() => LocationFilterKeyDataSourceImpl(serviceLocator<DioSettings>().dio));
  serviceLocator
      .registerLazySingleton(() => LocationFilterKeyRepositoryImpl(serviceLocator<LocationFilterKeyDataSourceImpl>()));
